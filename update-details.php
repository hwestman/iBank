				...
				<form name="update" method="post" action="#">
					...
					<div class="update-password">
						<table>
							...
							<tr><td>Confirm new password:</td><td><input name="confirmPassword" id="confirmPassword" type="password" size="50" maxlength="50" required placeholder="leave blank if no change"/></td></tr>
						</table>
