		...
		<div id="content">
			...
			<form name="interest-rate" method="post" action="<?php $_SERVER['PHP_SELF'];?>">
				<table>
					...
					<tr bgcolor="#CCC"><td>Credit</td><td><input type="text" name="credit" class="left" value="<?php echo $_SESSION['interestRates'][1];?>"/>%</td></tr>
					<tr bgcolor="#DDD"><td>Cheque</td><td><input type="text" name="cheque" class="left" value="<?php echo $_SESSION['interestRates'][2];?>"/>%</td></tr>
					<tr bgcolor="#CCC"><td>Loan</td><td><input type="text" name="loan" class="left" value="<?php echo $_SESSION['interestRates'][3];?>"/>%</td></tr>
				</table>
				<input type="reset" class="button" id="left" name="cancel" onclick="location.href='manager.php'" value="Cancel"/>
